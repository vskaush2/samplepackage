...
Ready to contribute? Here's how to set up `samplepackage` for local development.

1. Download a copy of `samplepackage` locally. 
...
Please note that the `samplepackage` project is released with a 
